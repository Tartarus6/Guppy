...
<div 
    ...
    tabindex="-1"
>
    <div class="bg-amber-700 p-6 w-96 max-w-full mx-4">
        ...
        <form onsubmit={async (e) => {
                ...
                {#if (typeof inputs[i].value == 'string')}
                    <div class="mb-4">
                        ...
                        <input 
                            ...
                            class="w-full px-3 py-2 bg-amber-600 text-white border border-amber-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
            ...
            <div class="flex gap-3 justify-end">
                <button 
                    type="button"
                    class="px-4 py-2 bg-amber-600 text-white hover:bg-amber-500 transition-colors"
